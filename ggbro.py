...
def banner():
    ...
    print(BRIGHT + GREEN)
    print(r"  ______     ______    |-----   ____   |======")
    print(r" |          |          |     |  |  /   |     |")
    print(r" |   ____   |   ____   |_____|  | /    |     |")
    print(r" |      |   |      |   |     |  | \    |     |")
    print(r" |______|   |______|   |_____|  |  \   |_____|") 
    print()
    print(r"     GGBRO: t.me/joinchat/wjyaLT-JHehiNGEy      ")
    print(RESET_ALL)
...
def spam_handler():
    ...
    phone = parse_phone(input(f"{BRIGHT}{BLUE}GGBRO >> {RESET_ALL}"))
    print()
    print("Использовать прокси? (y/n)")
    proxy = input(f"{BRIGHT}{BLUE}GGBRO >> {RESET_ALL}")
    if proxy.lower() == "y":
...
def update():
    ...
    update = input(f"{BRIGHT}{BLUE}GGBRO >> {RESET_ALL}")
    if update.lower() == "y":
        if exists("/usr/bin") and isfile("/usr/bin/GGBRO"):
